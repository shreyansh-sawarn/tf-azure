...
variable "enable_auto_scaling" { type = bool; default = true }
...
variable "service_cidr" { type = string; default = "10.2.0.0/16" }
variable "dns_service_ip" { type = string; default = "10.2.0.10" }
