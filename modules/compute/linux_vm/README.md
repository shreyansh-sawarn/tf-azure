...
Provisions an Azure Linux Virtual Machine with a Network Interface, configurable VM size, and optional Availability Set placement. Defaults to Ubuntu 24.04 LTS.
